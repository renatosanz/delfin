  ...
  def __init__(self) -> None:
    ...
    with dpg.font_registry():
      self.extrabold_font40 = dpg.add_font(
          file="./Inter-4.0/extras/ttf/InterDisplay-ExtraBold.ttf", size=40,
      ...
      dpg.add_font(
        file="./Inter-4.0/extras/ttf/Inter-Medium.ttf", size=17,
        tag="medium_font17"
      )
    ...
    with dpg.window(label="Main Menu",no_resize=True,id="main_menu",min_size=[800,1000],on_close=lambda:self.exit()):
      ...
      with dpg.group(horizontal=True):
        ...
        with dpg.group():
          ...
          dpg.add_button(label="Open a new file",callback=lambda:FilePickr(self.cntrlDataCubes))
          dpg.add_button(label="Recent files",callback=lambda:OpenRecent(self.cntrlDataCubes))
          dpg.add_button(label="Exit",tag="exit_btn",callback = lambda: self.exit())
