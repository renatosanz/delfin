...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=purple,
    pdftitle={Proyecto Estancia Delfdef integrar(flujo):
    suma = 0
    for i in flujo:
...
Este proceso lo he repetido con los cubos de datos manga-8456-6101, manga-8988-6104 y 
